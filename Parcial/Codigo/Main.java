 ...
 * Crea clientes, productos y pedidos, y muestra los detalles de cada pedido.
 */
public class Main {
        public static void main(String[] args) {
                ...
                // Agrupación de fotos en listas para las impresiones
                ...
                // Creación de impresiones con las fotos agrupadas
                Producto impresion1 = new ProductoConcreto(new ImpresionImplementacion(8, "Color", "Colección de paisajes", listaFotos1));
                Producto impresion2 = new ProductoConcreto(new ImpresionImplementacion(9, "Blanco y negro", "Fotos artísticas", listaFotos2));
                Producto impresion3 = new ProductoConcreto(new ImpresionImplementacion(10, "Color", "Recuerdos de viaje", listaFotos3));

                

                // Creación de pedidos utilizando el patrón Builder
